...
namespace A5Soft.A5App.Application.UseCases.Security
{
    ...
    public class QueryTenantsUseCase : QueryListUseCaseBase<TenantQueryResult>, IQueryTenantsUseCase
    {
        ...
        /// <inheritdoc />
        public QueryTenantsUseCase(ClaimsIdentity user, IUseCaseAuthorizer authorizer,
            IClientDataPortal dataPortal, IValidationEngineProvider validationProvider,
            IMetadataProvider metadataProvider, ILogger logger, ITenantRepository repository)
