...
namespace A5Soft.A5App.Application.UseCases.Security
{
    ...
    public class QueryUserRolesUseCase : QueryListUseCaseBase<UserRoleQueryResult>, IQueryUserRolesUseCase
    {
        ...
        /// <inheritdoc />
        public QueryUserRolesUseCase(ClaimsIdentity user, IUseCaseAuthorizer authorizer,
            IClientDataPortal dataPortal, IValidationEngineProvider validationProvider,
            IMetadataProvider metadataProvider, ILogger logger, IUserRoleRepository repository)
