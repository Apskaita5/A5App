...
namespace A5Soft.A5App.Application.UseCases.Security
{
        ...
        IUpdateTenantGroupAssignmentsUseCase
    {
        ...
        /// <inheritdoc />
        public UpdateTenantGroupAssignmentsUseCase(ClaimsIdentity user, IUseCaseAuthorizer authorizer,
            IClientDataPortal dataPortal, IValidationEngineProvider validationProvider,
            IMetadataProvider metadataProvider, ILogger logger, IUserGroupLookupService lookupService,
            ITenantRepository repository) : base(user, authorizer, dataPortal,
